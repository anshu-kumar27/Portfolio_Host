...
function Links({ isDark = false }) {
  const socialLinks = [
    { icon: FaGithub, label: "GitHub", link: "https://github.com/anshu-kumar27/" },
    { icon: FaLinkedin, label: "LinkedIn", link: "https://www.linkedin.com/in/anshu-kumar-63259521b/" },
    { icon: MdEmail, label: "Email", link: "mailto:anshukumar3552@gmail.com" },
    { icon: FaInstagram, label: "Instagram", link: "https://instagram.com/a.kumar0_" },
  ];
